import 'package:wpr_ccpc_4_12/Video_list_page/video_theme.dart';
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                        color: VideoTheme.buildLightTheme().dividerColor,
                      ),
                    ),
                    child: Material(
          ...
          child: Center(
            child: Text(
              ...
              style: TextStyle(
                  fontSize: 16,
                  fontWeight: FontWeight.w500,
                  color: VideoTheme.buildLightTheme().primaryColor),
            ),
          ),
        ),
      );
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              color: getIsItStartAndEndDate(date)
                                  ? VideoTheme.buildLightTheme().primaryColor
                                  : Colors.transparent,
                              borderRadius:
                                  const BorderRadius.all(Radius.circular(32.0)),
                              border: Border.all(
