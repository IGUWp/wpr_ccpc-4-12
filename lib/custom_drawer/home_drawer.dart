                        ...
                        child: RotationTransition(
                          ...
                          child: Container(
                            ...
                            child: ClipRRect(
                              ...
                              child: Image.network(userProvider.user.avatarurl),
                            ),
                          ),
                        ),
                      );
  ...
  Widget inkwell(DrawerList listData) {
    return Material(
      ...
      child: InkWell(
        ...
        onTap: () {
          navigationtoScreen(listData.index!); //让隔壁变成对应的页面
        },
        child: Stack(
          children: <Widget>[
            Container(
              ...
              child: Row(
                children: <Widget>[
                  ...
                  listData.isAssetsImage //list的东西中有的是icon有的是image，通过这个切换展示
                      ? Container(
                          width: 24,
                          height: 24,
            ...
            widget.screenIndex == listData.index //显示蓝色的透明条
                ? AnimatedBuilder(
                    animation: widget.iconAnimationController!,
                    builder: (BuildContext context, Widget? child) {
                      return Transform(
